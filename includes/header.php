...
<body>
      ...
      <ul class="nav">
       ...
       <li class="nav-item"><a class="nav-link" href="array.php">Simple Array and Prinouts</a></li>
       ...
       <li class="nav-item"><a class="nav-link" href="dateandtimemanip.php">Simple Date & Time Manipulation</a></li>
